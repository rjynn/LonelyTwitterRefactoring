...
public class LonelyTwitterActivity extends Activity {
	...
	private static final String SPECIAL_CHARACTER = "*";	//constants should be capitalized
	...
	public void save(View v) {
		...
		//LonelyTweet tweet;
//
	//	tweet = new NormalLonelyTweet(text);	//why even pass on a date?? it is creating it in the activity so it doesn't matter.
